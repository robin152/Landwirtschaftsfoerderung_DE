        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-12 mb-8 sm:mb-16">
          <div className="col-span-2 md:col-span-1">
            <a href="/" className="flex items-center gap-2 mb-3 sm:mb-4">
              <span className="font-bold text-sm sm:text-base text-foreground tracking-tight">Eskalator AG</span>
              <span className="text-xs text-muted-foreground font-normal">Fördermittelspezialisten</span>
            </a>
